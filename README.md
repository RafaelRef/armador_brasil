...
Referência observada: aplicativo para macOS exibindo versão 1.46, gravação do usuário de 08/09/2026 (3min39s, sem faixa de áudio), 13 screenshots e site público do fornecedor. Isso fixa uma referência observada; não comprova a versão mais recente de todas as plataformas.
